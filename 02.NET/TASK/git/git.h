...
#endif
// 设备信息
#define PROID "smartdevice&a1Yxobg0xMK"															 // 产品ID
#define DEVID "a1Yxobg0xMK.smartdevice|securemode=2,signmethod=hmacsha256,timestamp=1713370897147|" // 设备ID
#define AUTH_INFO "9507bf9a1b77515398ee352a8b91ef943f9f723fcb63017be8691aa5fc0b8d4e"						 // 鉴权信息
// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/a1Yxobg0xMK/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/a1Yxobg0xMK/test2" // 需要发布的主题
