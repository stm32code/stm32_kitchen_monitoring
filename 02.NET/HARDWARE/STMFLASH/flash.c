...
U32 addrShort3 = 0x0800C000 + 12 * 8; // 2
void W_Test(void)
{

   System_WriteInteriorFlash(addrShort1, (uint8_t *)&threshold_value_init.temp_value, sizeof(threshold_value_init.temp_value)); // 存入数据，函数内自动解锁，擦除，写入
	 System_WriteInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.mq2_value, sizeof(threshold_value_init.mq2_value)); // 存入数据，函数内自动解锁，擦除，写入
	 System_WriteInteriorFlash(addrShort3, (uint8_t *)&threshold_value_init.mq135_value, sizeof(threshold_value_init.mq135_value)); // 存入数据，函数内自动解锁，擦除，写入
...
void R_Test(void)
{
    ...
    System_ReadInteriorFlash(addrShort1, (uint8_t *)&threshold_value_init.temp_value, sizeof(threshold_value_init.temp_value)); // 读取数据，函数内自动按半字读取
    System_ReadInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.mq2_value, sizeof(threshold_value_init.mq2_value)); // 读取数据，函数内自动按半字读取
    System_ReadInteriorFlash(addrShort3, (uint8_t *)&threshold_value_init.mq135_value, sizeof(threshold_value_init.mq135_value)); // 读取数据，函数内自动按半字读取
